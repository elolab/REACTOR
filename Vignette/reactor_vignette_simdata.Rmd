---
title: "REACTOR vignette with simulated data"
author: "Markus Lindén, Sebastián Zúñiga Norman & Sini Junttila"
date: "2026-03-18"
...
|groups |Vector specifying the experimental groups (i.e. COVID, Healthy) as integers |In this case it is c(1,1,2,2)</font>. You can check this by viewing the regulonActivity dataframe and checking the column names and comparing them to the metadata you have |
...
|... |Parameters passed onto ROTS. See  [ROTS](https://www.bioconductor.org/packages/release/bioc/html/ROTS.html) |We will be setting seed to 1234 and K (top list size) to 100|
